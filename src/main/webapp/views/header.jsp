            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item  <%=request.getRequestURI().toString().equals(marketSettings) ? active: blank %>">
                    <a class="sidebar-link" href="<%=request.getContextPath()%><%=marketSettings%>">
                        <i class="fa-solid fa-cart-shopping mx-sm-1"></i> <span class="align-middle">Sotuv bo'lim</span>
                    </a>
                </li>
                <li class="sidebar-item  <%=request.getRequestURI().toString().equals(marketSettings) ? active: blank %>">
                    <a class="sidebar-link" href="<%=request.getContextPath()%><%=marketSettings%>">
                        <i class="fa-solid fa-store mx-sm-1"></i> <span class="align-middle">Magazine</span>
                    </a>
                </li>
                <li class="sidebar-item  <%=request.getRequestURI().toString().equals(marketSettings) ? active: blank %>">
